...
REGISTRY: dict[tuple[str, str], SourceEntry] = {
    ...
    # PDF per Part: https://link.epo.org/web/guidelines_for_examination_part_X_en.pdf
    # where X = a, b, c, d, e, f, g, h (lowercase)
    # Each PDF contains ALL chapters of that Part (e.g. Part G = Ch I-VII)
    # =========================================================================
    ("EP", "novelty"): SourceEntry(
        jurisdiction="EP", chapter="novelty",
        url="https://link.epo.org/web/guidelines_for_examination_part_g_en.pdf",
    ...
    ("EP", "claim_structure"): SourceEntry(
        ...
        url="https://link.epo.org/web/guidelines_for_examination_part_f_en.pdf",
    ...
    ("EP", "added_matter"): SourceEntry(
        ...
        url="https://link.epo.org/web/guidelines_for_examination_part_h_en.pdf",
    ...
    ("EP", "opposition"): SourceEntry(
        ...
        url="https://link.epo.org/web/guidelines_for_examination_part_d_en.pdf",
